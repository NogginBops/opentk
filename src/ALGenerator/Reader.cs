...
namespace ALGenerator
{
    ...
    public static class Reader
    {
        ...
        public static FileStream ReadALSpecFromGithub()
        {
        ...
        public static FileStream ReadALCSpecFromGithub()
        {
        ...
        public static FileStream ReadEFXPresetsSpecFromGithub()
        {
            string url = "https://raw.githubusercontent.com/NogginBops/OpenAL-EXT-Repository/refs/heads/xml-spec/xml/efxpresets.xml";
            string filePath = Path.Combine(TempDirectory, "efxpresets.xml");
